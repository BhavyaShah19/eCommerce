        ...
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap -m-4 justify-center mx-5">
            {Object.keys(products).map((item) => {
              { Object.keys(products).length === 0 && <p>Sorry!The tshirts are out of stock.New stock is coming soon,Stay Tuned!</p> }
                ...
                <div className="mt-4 text-center">
                  ...
                  <div className="mt-1">
                    ...
                    {products[item].color.includes('black') &&
                      <button className="border-2 border-black-700 ml-1 bg-gray-700 rounded-full w-6 h-6 focus:outline-none"></button>
                    }
